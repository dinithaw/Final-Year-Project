...
def generate_frames():
    ...
    cap = cv2.VideoCapture('/Users/dinithalakminwickramasinghe/Documents/FYP/Final-Year-Project/media/video.mp4')  # video file path
    ...
    while True:
        ...
        if not success:
            print("End of video or frame capture failed.")
            break
    ...
    cap.release()  # Release video after it finishes
